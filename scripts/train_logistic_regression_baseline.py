"""Train logistic regression baseline on one walk-forward split."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Train logistic regression baseline on a walk-forward split."
    )
    parser.add_argument(
        "--features",
        type=Path,
    ...
    parser.add_argument(
        ...
        type=int,
        default=1000,
        help="Maximum logistic regression optimizer iterations.",
    )
