"""Train random forest regressor baseline on one walk-forward split."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Train random forest regressor baseline on a walk-forward split."
    )
    parser.add_argument(
        "--features",
        type=Path,
...
def main() -> None:
    ...
    save_random_forest_regressor_model(result.model, args.model_output)
